  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {/* Meta */}
        <div className="flex flex-wrap items-center gap-5 pb-6 mb-6 border-b border-gray-200">
        ...
        <div className="flex items-center gap-3 pb-8 mb-8 border-b border-gray-200">
          ...
          <span className="text-sm font-body text-gray-500 mr-1">Share:</span>
          <a
            href={`https://wa.me/?text=${encodeURIComponent(post.title + ' — Read on NYSC Diary: ' + window.location.href)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-700 hover:bg-green-100 rounded-full text-xs font-display font-semibold transition-colors"
          >
          ...
          <a
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title + ' — via @nyscdiary')}&url=${encodeURIComponent(window.location.href)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-sky-50 text-sky-700 hover:bg-sky-100 rounded-full text-xs font-display font-semibold transition-colors"
          >
